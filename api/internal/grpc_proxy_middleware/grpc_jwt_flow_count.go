...
func GrpcJwtFlowCountMiddleware(serviceDetail *global.ServiceDetail) func(srv interface{}, ss grpc.ServerStream, info *grpc.StreamServerInfo, handler grpc.StreamHandler) error {
	return func(srv interface{}, ss grpc.ServerStream, info *grpc.StreamServerInfo, handler grpc.StreamHandler) error {
		...
		//	return err
		//}
		//appCounter, err := global.FlowCounterHandler.GetCounter(global.FlowAppPrefix + appInfo.AppID)
		//if err != nil {
		//	return err
		//}
		//appCounter.Increase()
